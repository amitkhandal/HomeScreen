...
//This class is used to handle dimensions for app using MediaQuery for variable size according to screens
class SizeConfig {
  ...
  // FONT SIZE
  static late double smallerFontSize = 0.0;
  static late double standardFontSize = 0.0;
